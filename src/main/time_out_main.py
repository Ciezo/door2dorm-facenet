    ...
    for x,y,w,h in faces:
        ...
        if (confidence > 70):
            ...
            if final_name in AUTHORIZED_NAMES:
                ...
                sql_log_time_in = "INSERT INTO SECURITY_LOGS_TIME_OUT (tenant_name, tenant_room, date, time_out, status, capture) VALUES (%s, %s, %s, %s, %s, %b)"
                val = (final_name, res_tenant_room, current_date, time_out, "Authorized", rgb_img)
                # val = {
            ...
            sql_log_time_in_UNAUTHORIZED = "INSERT INTO SECURITY_LOGS_TIME_OUT (tenant_name, tenant_room, date, time_out, status, capture) VALUES (%s, %s, %s, %s, %s, %b)"
            val2 = ('Unknown name', 'Unknown room', current_date, time_out, "Unauthorized", rgb_img)
